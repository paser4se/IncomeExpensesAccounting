...
const url = "http://localhost:8080/iea/api/evaluation/getAll";

class EvaluationView extends PageViewElement {
  async connectedCallback() {
    this.rowValues = await fetch(url)
      .then(res => res.json())
      .then(json => json.map(Object.values));
  }
        ...
        <div class="grid-container">
          ...
          <div id="chart">
            <google-chart
              ...
              rows=${JSON.stringify(this.rowValues)}
            >
            </google-chart>
          </div>
          <div id="table">
