...
=== Istzustand
Die Zahlungen werden von der Bank zur Verfügung gestellt und nach dem Einlesen im Programm automatisch verbucht.
...
=== Funktionsweise
image::function.png[Funktionsweise]

== Projekthandbuch "Organisatorische Rahmenbedingungen"

=== GANTT-Diagramm

Aufgrund von Unklarheiten bisher nur ein Link zum Youtrack Dashboard.

https://vm81.htl-leonding.ac.at/dashboard?id=0d73eb57-0918-49fe-8894-795347c81941[Youtrack Dashboard]
